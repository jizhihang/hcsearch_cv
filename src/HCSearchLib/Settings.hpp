...
namespace HCSearch
{
	...
	public:
		...
		string OUTPUT_HEURISTIC_MODEL_FILE_NAME;
		string OUTPUT_COST_H_MODEL_FILE_NAME;
		string OUTPUT_COST_ORACLE_H_MODEL_FILE_NAME;
		string OUTPUT_PRUNE_MODEL_FILE_NAME;
