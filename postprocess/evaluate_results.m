...
for s = searchTypes
    ...
    stat.maxmacroprec = zeros(1, length(timeRange));
    stat.maxmacrorec = zeros(1, length(timeRange));
    stat.maxmacrof1 = zeros(1, length(timeRange));
    ...
    stat.maxmicroprec = zeros(1, length(timeRange));
    stat.maxmicrorec = zeros(1, length(timeRange));
    stat.maxmicrof1 = zeros(1, length(timeRange));
    ...
    stat.binary_maxprec = zeros(1, length(timeRange));
    stat.binary_maxrec = zeros(1, length(timeRange));
    stat.binary_maxf1 = zeros(1, length(timeRange));
...
%                 prev = nodesPath;
    ...
    stat.maxmacroprec = max(stat.macroprec, [], 1);
    stat.maxmacrorec = max(stat.macrorec, [], 1);
    stat.maxmacrof1 = max(stat.macrof1, [], 1);
    ...
    stat.maxmicroprec = max(stat.microprec, [], 1);
    stat.maxmicrorec = max(stat.microrec, [], 1);
    stat.maxmicrof1 = max(stat.microf1, [], 1);
    ...
    stat.binary_maxprec = max(stat.binary_prec, [], 1);
    stat.binary_maxrec = max(stat.binary_rec, [], 1);
    stat.binary_maxf1 = max(stat.binary_f1, [], 1);
